...
// 
//
// Related Topics Dynamic Programming Tree Depth-First Search Binary Tree 👍 185
//14 👎 792
...
class Solution {
    ...
    public int maxSum(TreeNode root) {
        ...
        if (leftSum + rightSum + root.val > maxValue) {
            maxValue = leftSum + rightSum + root.val;
        }

        if (leftSum + root.val <= 0 && rightSum + root.val <= 0) {
            return 0;
        }
